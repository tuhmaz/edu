      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="navbar-nav flex-row align-items-center ms-auto me-3">
          <form method="POST" action="{{ route('setDatabase') }}" id="databaseForm">
            ...
            <div class="dropdown">
              <button type="button" class="btn btn-outline-warning    btn-icon rounded-pill dropdown-toggle hide-arrow" data-bs-toggle="dropdown" aria-expanded="false"> @php
                ...
                @endphp
                <img alt="Current Country" src="{{ asset('assets/img/flags/' . $flag) }}" style="width: 20px; height: 20px;">
              </button>
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="#" onclick="setDatabase('jo')"><img alt="Jordan" src="{{ asset('assets/img/flags/jordan.svg') }}" style="width: 20px; height: 20px;"> الأردن</a></li>
                <li><a class="dropdown-item" href="#" onclick="setDatabase('sa')"><img alt="Saudi Arabia" src="{{ asset('assets/img/flags/saudi.svg') }}" style="width: 20px; height: 20px;"> السعودية</a></li>
                <li><a class="dropdown-item" href="#" onclick="setDatabase('eg')"><img alt="Egypt" src="{{ asset('assets/img/flags/egypt.svg') }}" style="width: 20px; height: 20px;"> مصر</a></li>
                <li><a class="dropdown-item" href="#" onclick="setDatabase('ps')"><img alt="Palestine" src="{{ asset('assets/img/flags/palestine.svg') }}" style="width: 20px; height: 20px;"> فلسطين</a></li>
              </ul>
            </div>
          </form>
          <script>
        ...
        <div class="landing-menu-overlay d-lg-none">
              ...
              <li><a class="dropdown-item mt-0" href="{{ route('users.show', Auth::user()->id) }}">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0 me-2">
                      <div class="avatar avatar-online"><img src="{{ Auth::user()->profile_photo_path ? asset('storage/' . Auth::user()->profile_photo_path) : asset($randomAvatar) }}" alt="Avatar" class="rounded-circle"></div>
                    </div>
