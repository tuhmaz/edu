...
class ArticleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $articles = Article::on($connection)
            ->with(['schoolClass', 'subject', 'semester', 'keywords','author',])
            ->get();
    ...
    private function replaceKeywordsWithLinks($content, $keywords)
    {
        foreach ($keywords as $keyword) {
            ...
            $keywordLink = route('articles.indexByKeyword', ['keywords' => $keywordText]);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('articles.index', ['country' => $country])->with('success', 'Article and associated files deleted successfully.');
    }
    ...
    private function createInternalLinks($content, $keywords)
    {
        ...
        foreach ($keywordsArray as $keyword) {
            ...
            $url = route('articles.indexByKeyword', ['keywords' => $keyword]);
